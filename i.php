...
$fb = new Facebook([
  'app_id' => '242861496196301',
  'app_secret' => '3801ca5d29ed06d15dca51e99ce8b4be',
...
if (isset($accessToken)) {
    ...
    try {
		...
		if(isset($_POST['insert'])){
     	$data = ['source' => $fb->fileToUpload(__DIR__.'/photo1.jpg'), 'message' => 'Check out this app! It is awesome http://localhost/fbappOAuth/i.php '];
